...
//		url = "https://www.donga.com/news/article/all/20220412/112837367/1";
		url = "http://www.ggilbo.com/news/articleView.html?idxno=913528";
...
//		System.out.println("Start: " + Start);
		...
		for(int page = 1; page < 10; page=page+1) {
			for(int i=0; i < searchArr.length; i++ ) {
				...
				String url = "http://prt.ggilbo.com/engine_yonhap/search.php?page="+page+"&searchword="+keyword+"&picktab=article&searchcont=article&period=all&sort=date";
