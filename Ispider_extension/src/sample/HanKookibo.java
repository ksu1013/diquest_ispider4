...
public class HanKookibo {
	...
	public static void main(String[] args) {
		...
		HanKookibo test = new HanKookibo();
...
//		url = "https://www.donga.com/news/article/all/20220412/112837367/1";
		url = "https://www.hankookilbo.com/News/Read/A2022042417100003211";
	...
	public String changeHtml(String htmlSrc, String url2) {
		...
		HanKookibo commonUtil = new HanKookibo();
...
//		System.out.println("Start: " + Start);
		...
		for(int page = 1; page < 2; page=page+15) {
			for(int i=0; i < searchArr.length; i++ ) {
				...
				String url = "https://search.hankookilbo.com/Search?Page="+page+"&searchText="+keyword+"&tab=NEWS&sort=relation&searchTypeSet=TITLE,CONTENTS&selectedPeriod=%EC%A0%84%EC%B2%B4&filter=head";
...
//				System.out.println("htmlList"+htmlList);
		...
		System.out.println(htmlSrc);
			...
			//컨텐츠
			FORUM_CONTENTS = commonUtil.getSubStringResult("<div class=\"col-main\" itemprop=\"articleBody\">", "<div class=\"writer\">", htmlSrc);
			
			
			//작성일
			FORUM_DATE=commonUtil.getSubStringResult("<dt>입력</dt>", "</dd>", htmlSrc);
//			String FORUM_DATE_temp=commonUtil.getSubStringResult("<dt>입력</dt>", "</dd>", htmlSrc);
