...
//		url = "https://www.donga.com/news/article/all/20220412/112837367/1";
		url = "https://www.hani.co.kr/arti/economy/economy_general/1040266.html";
...
//		System.out.println("Start: " + Start);
		//페이지가 15 단위로 이어짐
		for(int page = 0; page < 10; page=page+1) {
			for(int i=0; i < searchArr.length; i++ ) {
				String keyword = searchArr[i];
				//System.out.println("keyword>>>"+keyword);
				
				String url = "https://search.hani.co.kr/Search?command=query&pageseq="+page+"&keyword="+keyword+"&media=news&submedia=&sort=d&period=all";
//				System.out.println("keyword: " + keyword);
...
//	
		...
		//System.out.println(htmlSrc);
			...
			//작성일
			FORUM_DATE = commonUtil.getSubStringResult("<p class=\"date-time\"><span><em>등록 :</em>", "</span>", htmlSrc);
