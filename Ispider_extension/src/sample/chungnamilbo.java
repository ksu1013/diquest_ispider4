...
public class chungnamilbo {
	...
	public static void main(String[] args) {
		...
		chungnamilbo test = new chungnamilbo();
...
//		url = "https://www.donga.com/news/article/all/20220412/112837367/1";
		url = "https://www.chungnamilbo.co.kr/news/articleView.html?idxno=665259";
	...
	public String changeHtml(String htmlSrc, String url2) {
		...
		chungnamilbo commonUtil = new chungnamilbo();
...
//		System.out.println("Start: " + Start);
		...
		for(int page = 1; page < 10; page=page+1) {
			for(int i=0; i < searchArr.length; i++ ) {
				...
				String url = "https://www.chungnamilbo.co.kr/news/articleList.html?page="+page+"&sc_word="+keyword+"&sc_area=A&view_type=sm";
