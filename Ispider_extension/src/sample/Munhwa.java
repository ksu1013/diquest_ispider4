...
//		url = "https://www.donga.com/news/article/all/20220412/112837367/1";
		url = "http://www.munhwa.com/news/view.html?no=2022062701030321306001";
...
//		System.out.println("Start: " + Start);
		//페이지가 15 단위로 이어짐
		for(int page = 0; page < 30; page=page+10) {
			for(int i=0; i < searchArr.length; i++ ) {
				String keyword = searchArr[i];
				//System.out.println("keyword>>>"+keyword);
				String url = "http://mhsearch.munhwa.com/search.php?startCount="+page+"&query="+keyword+"&mode=basic&sort=DESC&collection=news&range=A&startDate=&endDate=&searchField=ALL&reQuery=&reporter=&reQuery=&reporter=&searchField=ALL&div_code=ALL&range=A&sort=DESC";
//				System.out.println("keyword: " + keyword);
...
//			System.out.println("responseCode: "+responseCode);
			...
			BufferedReader in = new BufferedReader(new InputStreamReader(hurlc.getInputStream(), "euc-kr"));
